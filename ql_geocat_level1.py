...
def _argparse():
    ...
    parser.add_argument(
                      ...
                      dest='input_file',
                      type=str,
                      help='''The fully qualified path to a single geocat level-1 NetCDF4''' \
                              ''' input file.'''
                      )
    ...
    parser.add_argument(
                      ...
                      dest="dataset",
                      type=str,
                      help='''The geocat level-1 dataset to plot. See the --list_datasets''' \
...
def main():
    ...
    subsatellite_lon = sat_l1_obj.attrs['Subsatellite_Longitude']
    LOG.info("Local subsatellite_lon = {}".format(subsatellite_lon))
    sat_obj.set_subsatellite_lon(subsatellite_lon)
    LOG.info("sat_obj subsatellite_lon = {}".format(sat_obj.subsatellite_lon))
